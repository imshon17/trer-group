sap.ui.define([
	...
	"sap/ui/core/Core",
	"sap/m/MessageToast",
], function(Device, Controller, BaseController, Filter, FilterOperator, JSONModel, Fragment, Item, Core, MessageToast) {
	"use strict";
	...
	return BaseController.extend("sap.ui.demo.todo.controller.Home", {
		...
		onInit: function() {
			...
			oRouter.getRoute("Home").attachPatternMatched(this._onPatternMatched, this);
		},

		_onPatternMatched: async function(oEvent) {
			var userId = oEvent.getParameter("arguments").idUtente;
			var utente = await this.callDatabaseMethods("utente/get/" + userId, "GET", null); 
			if (utente !== "KO") {
				...
				this.getView().setModel(oModel, "modelPlanning");
			}
		},
